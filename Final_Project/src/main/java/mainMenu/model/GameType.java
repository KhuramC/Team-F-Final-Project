...
/**
 * An enum for the four games available to play. Every enum has an associated
...
public enum GameType {
	...
	/**
	 * Parameterized constructor for the enum, requiring a concise description of
	 * the game be passed in.
	 * 
